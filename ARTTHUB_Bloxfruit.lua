...
_G.Color = Color3.fromRGB(249, 214, 46)
...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('ARTT Hub BF Premium') then
        makefolder('ARTT Hub BF Premium')
    end
    if not _G.Dis and not isfile('ARTT Hub BF Premium/'..Name..'.json') then
        writefile('ARTT Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('ARTT Hub BF Premium') and isfile('ARTT Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('ARTT Hub BF Premium/'..Name..'.json'))
	...
	-- Old World
		...
		function CheckLevel()
			...
			if Old_World then
				if Lv == 1 or Lv <= 9 or SelectMonster == "Bandit [Lv. 5]" then -- Bandit
                    ...
                    CFrameNearMon = CFrame.new(1190.8155517578125, 16.703508377075195, 1616.51806640625)
				...
				elseif Lv == 10 or Lv <= 14 or SelectMonster == "Monkey [Lv. 14]" then -- Monkey
                    ...
                    CFrameNearMon = CFrame.new(-1667.474853515625, 22.852418899536133, -50.30442810058594)
				...
				elseif Lv == 15 or Lv <= 29 or SelectMonster == "Gorilla [Lv. 20]" then -- Gorilla
					...
					NameMon = "Gorilla"
					CFrameQ = CFrame.new(-1601.6553955078, 36.85213470459, 153.38809204102)
                    CFrameNearMon = CFrame.new(-1280.512939453125, 6.220484733581543, -506.76654052734375)
				...
				elseif Lv == 30 or Lv <= 39 or SelectMonster == "Pirate [Lv. 35]" then -- Pirate
                    ...
                    CFrameNearMon = CFrame.new(-1217.3555908203125, 4.752061367034912, 3903.396484375)
				...
				elseif Lv == 40 or Lv <= 59 or SelectMonster == "Brute [Lv. 45]" then -- Brute
					...
					NameMon = "Brute"
					CFrameQ = CFrame.new(-1140.1761474609, 4.752049446106, 3827.4057617188)
                    CFrameNearMon = CFrame.new(-1320.5875244140625, 15.089882850646973, 4299.39599609375)
				...
				elseif Lv == 60 or Lv <= 74 or SelectMonster == "Desert Bandit [Lv. 60]" then -- Desert Bandit
                    ...
                    CFrameNearMon = CFrame.new(919.0504760742188, 6.44896125793457, 4475.541015625)
				...
				elseif Lv == 75 or Lv <= 89 or SelectMonster == "Desert Officer [Lv. 70]" then -- Desert Officer
					...
					CFrameQ = CFrame.new(896.51721191406, 6.4384617805481, 4390.1494140625)
                    CFrameNearMon = CFrame.new(1625.8199462890625, 1.6109663248062134, 4365.416015625)
				...
				elseif Lv == 90 or Lv <= 99 or SelectMonster == "Snow Bandit [Lv. 90]" then -- Snow Bandit
                    ...
                    CFrameNearMon = CFrame.new(1322.5911865234375, 87.27277374267578, -1347.128173828125)
				...
				elseif Lv == 100 or Lv <= 119 or SelectMonster == "Snowman [Lv. 100]" then -- Snowman
					...
					NameMon = "Snowman"
					CFrameQ = CFrame.new(1386.8073730469, 87.272789001465, -1298.3576660156)
                    CFrameNearMon = CFrame.new(1176.4669189453125, 105.77351379394531, -1485.537353515625)
				...
				elseif Lv == 150 or Lv <= 174 or SelectMonster == "Sky Bandit [Lv. 150]" then -- Sky Bandit
                    ...
                    CFrameNearMon = CFrame.new(-5004.888671875, 278.06695556640625, -2830.07958984375)
					CFrameMon = CFrame.new(-4955.6411132813, 365.46365356445, -2908.1865234375)
				elseif Lv == 175 or Lv <= 190-1 or SelectMonster == "Dark Master [Lv. 175]" then -- Dark Master
					Ms = "Dark Master [Lv. 175]"
					NameQuest = "SkyQuest"
					QuestLv = 2
					NameMon = "Dark Master"
					CFrameQ = CFrame.new(-4842.1372070313, 717.69543457031, -2623.0483398438)
                    CFrameNearMon = CFrame.new(-5261.1533203125, 388.6519470214844, -2247.109375)
					CFrameMon = CFrame.new(-5148.1650390625, 439.04571533203, -2332.9611816406)
                elseif Lv >= 190 or Lv <= 210-1 or SelectMonster == "Prisoner [Lv. 190]" then
                    Ms = "Prisoner [Lv. 190]"
					QuestLv = 1
                ...
                elseif Lv >= 210 or Lv <= 250-1 or SelectMonster == "Dangerous Prisoner [Lv. 210]" then
			...
			if Three_World then
				...
				elseif Lv >= 2225 and Lv <= 2300 or SelectMonster == "Cake Guard [Lv. 2225]" then
					...
					CFrameQ = CFrame.new(-2017.4874267578125, 36.85276412963867, -12027.53515625)
                elseif Lv >= 2300 and Lv <= 2325 or SelectMonster == "Cocoa Warrior [Lv. 2300]" then
                    Ms = "Cocoa Warrior [Lv. 2300]"
                    NameQuest = "ChocQuest1"
                    QuestLv = 1
                    NameMon = "Cocoa Warrior"
                    CFrameQ =   CFrame.new(231.2646942138672, 30.67750358581543, -12199.765625)
                    CFrameMon = CFrame.new(-11.268909454345703, 24.734355926513672, -12210.3779296875)
                elseif Lv >= 2325 and Lv <= 2350 or SelectMonster == "Chocolate Bar Battlers [Lv. 2325]" then
                    Ms = "Chocolate Bar Battlers [Lv. 2325]"
                    NameQuest = "ChocQuest1"
                    QuestLv = 2
                    NameMon = "Chocolate Bar Battlers"
                    CFrameQ = CFrame.new(231.2646942138672, 30.67750358581543, -12199.765625)
                    CFrameMon = CFrame.new(648.9827270507812, 24.73427391052246, -12551.6318359375)
                elseif Lv >= 2350 and Lv <= 2375 or SelectMonster == "Sweet Thief [Lv. 2350]" then
                    Ms= "Sweet Thief [Lv. 2350]"
                    NameQuest = "ChocQuest2"
                    QuestLv = 1
                    NameMon = "Sweet Thiefs"
                    CFrameQ = CFrame.new(150.8040313720703, 30.667917251586914, -12774.6884765625)
                    CFrameMon = CFrame.new(4.2881951332092285, 24.793920516967773, -12621)
                elseif Lv >= 2375 and SelectMonster == "Candy Rebel [Lv. 2375]" then
                    Ms = "Candy Rebel [Lv. 2375]"
                    NameQuest = "ChocQuest2"
                    QuestLv = 2
                    NameMon = "Candy Rebels"
                    CFrameQ = CFrame.new(150.8040313720703, 30.667917251586914, -12774.6884765625)
                    CFrameMon = CFrame.new(66.76439666748047, 24.793851852416992, -12947.1494140625)
				end
			end
		end
		...
		function CheckLevel2()
			...
			if Old_World and not Auto_Raid then
                ...
                elseif Lv >= 75 and Lv <= 90-1 or SelectMonster == "Desert Officer [Lv. 70]" then
					...
					NameMon = "Desert Officer"
					CFrameQ = CFrame.new(894.488647, 5.14000702, 4392.43359, 0.819155693, -0, -0.573571265, 0, 1, -0, 0.573571265, 0, 0.819155693)
					CFrameNearMon = CFrame.new(1606.41064453125, 1.6109663248062134, 4366.705078125)
					CFrameMon = CFrame.new(1621.54638671875, 1.6109663248062134, 4381.86572265625)
					TelePBoss(CFrameQ)

				elseif Lv >= 90 and Lv <= 100-1 or SelectMonster == "Snow Bandit [Lv. 90]" then -- Snow Bandits
					Ms = "Snow Bandit [Lv. 90]"
					NameQuest = "SnowQuest"
					QuestLv = 1
				...
				elseif Lv == 100 and Lv <= 119 or SelectMonster == "Snowman [Lv. 100]" then -- Snowman
					...
					_G.Farm_Mon = true
				elseif Lv == 120 or Lv <= 150-1 or SelectMonster == "Chief Petty Officer [Lv. 120]" then -- Chief Petty Officer
					Ms = "Chief Petty Officer [Lv. 120]"
					NameQuest = "MarineQuest2"
					QuestLv = 1
					NameMon = "Chief Petty Officer"
					CFrameQ = CFrame.new(-5039.58643, 27.3500385, 4324.68018, 0, 0, -1, 0, 1, 0, 1, 0, 0)
					CFrameNearMon = CFrame.new(-4691.5595703125, 20.65204429626465, 4459.10693359375)
					CFrameMon = CFrame.new(-4656.89208984375, 20.65204429626465, 4461.32421875)
					TelePBoss(CFrameQ)
					if Lv >= 130 then
						_G.SelectBoss = "Vice Admiral [Lv. 130] [Boss]"
					end
					
				elseif Lv >= 150 and Lv <= 175-1 or SelectMonster == "Sky Bandit [Lv. 150]" then -- Sky Bandit
					Ms = "Sky Bandit [Lv. 150]"
					NameQuest = "SkyQuest"
					QuestLv = 1
					NameMon = "Sky Bandit"
					...
					CFrameNearMon = CFrame.new(-5004.888671875, 278.06695556640625, -2830.07958984375)
					CFrameMon = CFrame.new(-5010.583984375, 278.0670471191406, -2851.810546875)
					TelePBoss(CFrameQ)
					
				elseif Lv >= 175 and Lv <= 190-1 or SelectMonster == "Dark Master [Lv. 175]" then -- Dark Master
					...
					CFrameQ = CFrame.new(-4839.53027, 716.368591, -2619.44165, 0.866007268, 0, 0.500031412, 0, 1, 0, -0.500031412, 0, 0.866007268)
                    CFrameNearMon = CFrame.new(-5261.1533203125, 388.6519470214844, -2247.109375)
					CFrameMon = CFrame.new(-5250.10595703125, 388.6519470214844, -2271.2958984375)
					TelePBoss(CFrameQ)

				elseif Lv >= 190 and Lv <= 210-1 or SelectMonster == "Prisoner [Lv. 190]" then
					...
					NameMon = "Prisoner"
					CFrameQ = CFrame.new(5308.93115, 1.65517521, 475.120514, -0.0894274712, -5.00292918e-09, -0.995993316, 1.60817859e-09, 1, -5.16744869e-09, 0.995993316, -2.06384709e-09, -0.0894274712)
                    CFrameNearMon = CFrame.new(5173.47119140625, 2.6011507511138916, 407.7026062011719)
					CFrameMon = CFrame.new(5433.39307, 88.678093, 514.986877, 0.879988372, 0, -0.474995494, 0, 1, 0, 0.474995494, 0, 0.879988372)
					TelePBoss(CFrameQ)
				...
				elseif Lv == 210 or Lv <= 249 or SelectMonster == "Dangerous Prisoner [Lv. 210]" then
					...
					NameMon = "Dangerous Prisoner"
					CFrameQ = CFrame.new(5308.93115, 1.65517521, 475.120514, -0.0894274712, -5.00292918e-09, -0.995993316, 1.60817859e-09, 1, -5.16744869e-09, 0.995993316, -2.06384709e-09, -0.0894274712)
					CFrameNearMon = CFrame.new(5557.85986328125, 1.6335057020187378, 523.345703125)
					CFrameMon = CFrame.new(5433.39307, 88.678093, 514.986877, 0.879988372, 0, -0.474995494, 0, 1, 0, 0.474995494, 0, 0.879988372)
					TelePBoss(CFrameQ)
					if Lv >= 240 then
				...
				elseif Lv == 250 or Lv <= 274 or SelectMonster == "Toga Warrior [Lv. 250]" then -- Toga Warrior
					...
					CFrameNearMon = CFrame.new(-1693.07470703125, 7.289083480834961, -2695.165771484375)
					CFrameMon = CFrame.new(-1779.97583, 44.6077499, -2736.35474, 0.984437346, 4.10396339e-08, 0.175734788, -3.62286876e-08, 1, -3.05844168e-08, -0.175734788, 2.3741821e-08, 0.984437346)
					TelePBoss(CFrameQ)
					
				elseif Lv == 275 or Lv <= 300 or SelectMonster == "Gladiator [Lv. 275]" then -- Gladiato
					...
					NameMon = "Gladiato"
					CFrameQ = CFrame.new(-1576.11743, 7.38933945, -2983.30762, 0.576966345, 1.22114863e-09, 0.816767931, -3.58496594e-10, 1, -1.24185606e-09, -0.816767931, 4.2370063e-10, 0.576966345)
					CFrameNearMon = CFrame.new(-1323.7056884765625, 7.442556381225586, -3246.76416015625)
				...
				elseif Lv == 300 or Lv <= 324 or SelectMonster == "Military Soldier [Lv. 300]" then -- Military Soldier
					...
					CFrameNearMon = CFrame.new(-5494.76171875, 8.983367919921875, 8423.94140625)
				...
				elseif Lv == 325 or Lv <= 374 or SelectMonster == "Military Spy [Lv. 325]" then -- Military Spy
					...
					NameMon = "Military Spy"
					CFrameQ = CFrame.new(-5316.55859, 12.2370615, 8517.2998, 0.588437557, -1.37880001e-08, -0.808542669, -2.10116209e-08, 1, -3.23446478e-08, 0.808542669, 3.60215964e-08, 0.588437557)
					CFrameNearMon = CFrame.new(-5843.57080078125, 77.23064422607422, 8835.1015625)
				...
				elseif Lv == 375 or Lv <= 399 or SelectMonster == "Fishman Warrior [Lv. 375]" then -- Fishman Warrior
					...
					CFrameNearMon = CFrame.new(60877.44140625, 18.482830047607422, 1558.9688720703125)
				...
				elseif Lv == 400 or Lv <= 449 or SelectMonster == "Fishman Commando [Lv. 400]" then -- Fishman Commando
					...
					CFrameNearMon = CFrame.new(61902.27734375, 18.482830047607422, 1494.6409912109375)
				...
				elseif Lv == 450 or Lv <= 474 or SelectMonster == "God's Guard [Lv. 450]" then 
					...
					CFrameNearMon = CFrame.new(-4707.515625, 845.2769775390625, -1911.1031494140625)
				...
				elseif Lv == 475 or Lv <= 524 or SelectMonster == "Shanda [Lv. 475]" then
					...
					CFrameNearMon = CFrame.new(-7635.947265625, 5545.49169921875, -515.2319946289062)
				...
				elseif Lv == 525 or Lv <= 549 or SelectMonster == "Royal Squad [Lv. 525]" then -- Royal Squad
					...
					CFrameNearMon = CFrame.new(-7639.01611328125, 5606.876953125, -1472.419189453125)
				...
				elseif Lv == 550 or Lv <= 624 or SelectMonster == "Royal Soldier [Lv. 550]" then -- Royal Soldier
					...
					NameMon = "Royal Soldier"
					CFrameQ = CFrame.new(-7906.81592, 5634.6626, -1411.99194, 0, 0, -1, 0, 1, 0, 1, 0, 0)
					CFrameNearMon = CFrame.new(-7830.197265625, 5606.876953125, -1733.08251953125)
				...
				elseif Lv == 625 or Lv <= 649 or SelectMonster == "Galley Pirate [Lv. 625]" then -- Galley Pirate
					...
					CFrameNearMon = CFrame.new(5586.47412109375, 38.538639068603516, 3984.612548828125)
				...
				elseif Lv >= 650 or SelectMonster == "Galley Captain [Lv. 650]" then -- Galley Captain
					...
					NameMon = "Galley Captain"
					CFrameQ = CFrame.new(5259.81982, 37.3500175, 4050.0293, 0.087131381, 0, 0.996196866, 0, 1, 0, -0.996196866, 0, 0.087131381)
					CFrameNearMon = CFrame.new(5667.76904296875, 38.50114059448242, 4931.72802734375)
			...
			if New_World and not Auto_Raid then
				...
				if Lv == 700 or Lv <= 724 or SelectMonster == "Raider [Lv. 700]" then -- Raider [Lv. 700]
					...
					QuestLv = 1
					NameMon = "Raider"
					CFrameQ = CFrame.new(-425.3813171386719, 72.97052764892578, 1836.9521484375)
					CFrameNearMon = CFrame.new(334.77734375, 39.13896560668945, 2306.916259765625)
				...
				elseif Lv == 725 or Lv <= 774 or SelectMonster == "Mercenary [Lv. 725]" then -- Mercenary [Lv. 725]
					...
					CFrameNearMon = CFrame.new(-984.8427124023438, 73.15985870361328, 1383.1341552734375)
				...
				elseif Lv == 775 or Lv <= 799 or SelectMonster == "Swan Pirate [Lv. 775]" then -- Swan Pirate [Lv. 775]
					...
					CFrameNearMon = CFrame.new(1034.1392822265625, 73.06974029541016, 1116.385498046875)
				...
				elseif Lv == 800 or Lv <= 874 or SelectMonster == "Factory Staff [Lv. 800]" then -- Factory Staff [Lv. 800]
					...
					NameMon = "Factory Staff"
					CFrameQ = CFrame.new(638.43811, 71.769989, 918.282898, 0.139203906, 0, 0.99026376, 0, 1, 0, -0.99026376, 0, 0.139203906)
					CFrameNearMon = CFrame.new(299.77459716796875, 72.95976257324219, 30.93536376953125)
				...
				elseif Lv == 875 or Lv <= 899 or SelectMonster == "Marine Lieutenant [Lv. 875]" then -- Marine Lieutenant [Lv. 875]
					...
					CFrameNearMon = CFrame.new(-2888.216796875, 73.07788848876953, -3054.686767578125)
				...
				elseif Lv == 900 or Lv <= 949 or SelectMonster == "Marine Captain [Lv. 900]" then -- Marine Captain [Lv. 900]
					...
					NameMon = "Marine Captain"
					CFrameQ = CFrame.new(-2440.79639, 71.7140732, -3216.06812, 0.866007268, 0, 0.500031412, 0, 1, 0, -0.500031412, 0, 0.866007268)
					CFrameNearMon = CFrame.new(-1921.3626708984375, 73.16555786132812, -3220.5205078125)
				...
				elseif Lv == 950 or Lv <= 974 or SelectMonster == "Zombie [Lv. 950]" then -- Zombie [Lv. 950]
					...
					CFrameNearMon = CFrame.new(-5706.8271484375, 48.48019027709961, -929.623779296875)
				...
				elseif Lv == 975 or Lv <= 999 or SelectMonster == "Vampire [Lv. 975]" then -- Vampire [Lv. 975]
					...
					NameMon = "Vampire"
					CFrameQ = CFrame.new(-5497.06152, 47.5923004, -795.237061, -0.29242146, 0, -0.95628953, 0, 1, 0, 0.95628953, 0, -0.29242146)
					CFrameNearMon = CFrame.new(-6007.4091796875, 6.402710914611816, -1299.11767578125)
				...
				elseif Lv == 1000 or Lv <= 1049 or SelectMonster == "Snow Trooper [Lv. 1000]" then -- Snow Trooper [Lv. 1000] **
					...
					CFrameNearMon = CFrame.new(586.65478515625, 401.42193603515625, -5554.1474609375)
				...
				elseif Lv == 1050 or Lv <= 1099 or SelectMonster == "Winter Warrior [Lv. 1050]" then -- Winter Warrior [Lv. 1050]
					...
					NameMon = "Winter Warrior"
					CFrameQ = CFrame.new(609.858826, 400.119904, -5372.25928, -0.374604106, 0, 0.92718488, 0, 1, 0, -0.92718488, 0, -0.374604106)
					CFrameNearMon = CFrame.new(1351.64306640625, 429.421875, -5323.2890625)
				...
				elseif Lv == 1100 or Lv <= 1124 or SelectMonster == "Lab Subordinate [Lv. 1100]" then -- Lab Subordinate [Lv. 1100]
					...
					CFrameNearMon = CFrame.new(-5726.8115234375, 15.951770782470703, -4527.396484375)
				...
				elseif Lv == 1125 or Lv <= 1174 or SelectMonster == "Horned Warrior [Lv. 1125]" then -- Horned Warrior [Lv. 1125]
					...
					NameMon = "Horned Warrior"
					CFrameQ = CFrame.new(-6064.06885, 15.2422857, -4902.97852, 0.453972578, -0, -0.891015649, 0, 1, -0, 0.891015649, 0, 0.453972578)
					CFrameNearMon = CFrame.new(-6330.45458984375, 30.044347763061523, -5965.51611328125)
				...
				elseif Lv == 1175 or Lv <= 1199 or SelectMonster == "Magma Ninja [Lv. 1175]" then -- Magma Ninja [Lv. 1175]
					...
					CFrameNearMon = CFrame.new(-5436.201171875, 17.390695571899414, -5926.279296875)
				...
				elseif Lv == 1200 or Lv <= 1249 or SelectMonster == "Lava Pirate [Lv. 1200]" then 
					...
					CFrameNearMon = CFrame.new(-5231.93115234375, 52.052486419677734, -4733.2626953125)
				...
				elseif Lv == 1250 or Lv <= 1274 or SelectMonster == "Ship Deckhand [Lv. 1250]" then 
					...
					CFrameNearMon = CFrame.new(1211.6021728515625, 125.05711364746094, 33049.828125)
				...
				elseif Lv == 1275 or Lv <= 1299 or SelectMonster == "Ship Engineer [Lv. 1275]" then 
					...
					NameMon = "Ship Engineer"
					CFrameQ = CFrame.new(1037.80127, 125.092171, 32911.6016, -0.244533166, -0, -0.969640911, -0, 1.00000012, -0, 0.96964103, 0, -0.244533136)
					CFrameNearMon = CFrame.new(925.927734375, 40.05690383911133, 32745.486328125)
				...
				elseif Lv == 1300 or Lv <= 1324 or SelectMonster == "Ship Steward [Lv. 1300]" then 
					...
					CFrameNearMon = CFrame.new(918.2132568359375, 129.55599975585938, 33442.60546875)
				...
				elseif Lv == 1325 or Lv <= 1349 or SelectMonster == "Ship Officer [Lv. 1325]" then 
					...
					NameMon = "Ship Officer"
					CFrameQ = CFrame.new(968.80957, 125.092171, 33244.125, -0.869560242, 1.51905191e-08, -0.493826836, 1.44108379e-08, 1, 5.38534195e-09, 0.493826836, -2.43357912e-09, -0.869560242)
					CFrameNearMon = CFrame.new(714.5082397460938, 181.0575408935547, 33321.90234375)
				...
				elseif Lv == 1350 or Lv <= 1374 or SelectMonster == "Arctic Warrior [Lv. 1350]" then 
					...
					CFrameNearMon = CFrame.new(6068.52685546875, 28.366724014282227, -6209.42236328125)
				...
				elseif Lv == 1375 or Lv <= 1424 or SelectMonster == "Snow Lurker [Lv. 1375]" then -- Snow Lurker [Lv. 1375]
					...
					NameMon = "Snow Lurker"
					CFrameQ = CFrame.new(5667.6582, 26.7997818, -6486.08984, -0.933587909, 0, -0.358349502, 0, 1, 0, 0.358349502, 0, -0.933587909)
					CFrameNearMon = CFrame.new(5537.95751953125, 28.130380630493164, -6795.2265625)
				...
				elseif Lv == 1425 or Lv <= 1449 or SelectMonster == "Sea Soldier [Lv. 1425]" then -- Sea Soldier [Lv. 1425]
					...
					CFrameNearMon = CFrame.new(-3357.0009765625, 26.956235885620117, -9779.986328125)
				...
				elseif Lv >= 1450 or SelectMonster == "Water Fighter [Lv. 1450]" then -- Water Fighter [Lv. 1450]
					...
					NameMon = "Water Fighter"
					CFrameQ = CFrame.new(-3054.44458, 235.544281, -10142.8193, 0.990270376, -0, -0.13915664, 0, 1, -0, 0.13915664, 0, 0.990270376)
					CFrameNearMon = CFrame.new(-3552.8427734375, 239.4066925048828, -10520.5234375)
			...
			if Three_World and not Auto_Raid then
				if Lv >= 1500 and Lv <= 1524 or SelectMonster == "Pirate Millionaire [Lv. 1500]" then -- Pirate Millionaire [Lv. 1500]
					...
					CFrameNearMon = CFrame.new(-175.69410705566406, 43.82997131347656, 5514.1748046875)
				...
				elseif Lv >= 1525 and Lv <= 1574 or SelectMonster == "Pistol Billionaire [Lv. 1525]" then -- Pistol Billionaire [Lv. 1525]
					...
					NameMon = "Pistol Billionaire"
					CFrameQ = CFrame.new(-290.074677, 42.9034653, 5581.58984, 0.965929627, -0, -0.258804798, 0, 1, -0, 0.258804798, 0, 0.965929627)
					CFrameNearMon = CFrame.new(-481.789306640625, 73.8299560546875, 5889.49658203125)
					CFrameMon = CFrame.new(81.164993286133, 43.755737304688, 5724.7021484375)
					TelePBoss(CFrameQ)
				...
				elseif Lv >= 1575 and Lv <= 1599 or SelectMonster == "Dragon Crew Warrior [Lv. 1575]" then -- Dragon Crew Warrior [Lv. 1575]
					...
					CFrameNearMon = CFrame.new(6565.75390625, 51.49629211425781, -984.544921875)
				...
				elseif Lv >= 1600 and Lv <= 1624 or SelectMonster == "Dragon Crew Archer [Lv. 1600]" then -- Dragon Crew Archer [Lv. 1600]
					...
					NameMon = "Dragon Crew Archer"
					CFrameQ = CFrame.new(5832.83594, 51.6806107, -1101.51563, 0.898790359, -0, -0.438378751, 0, 1, -0, 0.438378751, 0, 0.898790359)
					CFrameNearMon = CFrame.new(6672.80126953125, 378.3912658691406, 302.4419250488281)
				...
				elseif Lv >= 1625 and Lv <= 1649 or SelectMonster == "Female Islander [Lv. 1625]" then -- Female Islander [Lv. 1625]
					...
					CFrameNearMon = CFrame.new(4744.3642578125, 730.333740234375, 746.1234741210938)
				...
				elseif Lv >= 1650 and Lv <= 1699 or SelectMonster == "Giant Islander [Lv. 1650]" then -- Giant Islander [Lv. 1650]
					...
					NameMon = "Giant Islander"
					CFrameQ = CFrame.new(5448.86133, 601.516174, 751.130676, 0, 0, 1, 0, 1, -0, -1, 0, 0)
					CFrameNearMon = CFrame.new(4874.412109375, 590.436767578125, -80.99021911621094)
				...
				elseif Lv >= 1700 and Lv <= 1724 or SelectMonster == "Marine Commodore [Lv. 1700]" then -- Marine Commodore [Lv. 1700]
					...
					CFrameNearMon = CFrame.new(2846.656494140625, 73.122314453125, -7775.728515625)
				...
				elseif Lv >= 1725 and Lv <= 1774 or SelectMonster == "Marine Rear Admiral [Lv. 1725]" then -- Marine Rear Admiral [Lv. 1725]
					...
					NameMon = "Marine Rear Admiral"
					CFrameQ = CFrame.new(2180.54126, 27.8156815, -6741.5498, -0.965929747, 0, 0.258804798, 0, 1, 0, -0.258804798, 0, -0.965929747)
					CFrameNearMon = CFrame.new(3675.12353515625, 160.52406311035156, -7080.0458984375)
				...
				elseif Lv >= 1775 and Lv <= 1799 or SelectMonster == "Fishman Raider [Lv. 1775]" then -- Fishman Raider [Lv. 1775]
					...
					CFrameNearMon = CFrame.new(-10388.9853515625, 331.76263427734375, -8359.0712890625)
				...
				elseif Lv >= 1800 and Lv <= 1824 or SelectMonster == "Fishman Captain [Lv. 1800]" then -- Fishman Captain [Lv. 1800]
					...
					NameMon = "Fishman Captain"
					CFrameQ = CFrame.new(-10581.6563, 330.872955, -8761.18652, -0.882952213, 0, 0.469463557, 0, 1, 0, -0.469463557, 0, -0.882952213)
					CFrameNearMon = CFrame.new(-10983.708984375, 331.76263427734375, -8926.9970703125)
				...
				elseif Lv >= 1825 and Lv <= 1849 or SelectMonster == "Forest Pirate [Lv. 1825]" then -- Forest Pirate [Lv. 1825]
					...
					CFrameNearMon = CFrame.new(-13479.2177734375, 332.3781433105469, -7853.541015625)
				...
				elseif Lv >= 1850 and Lv <= 1899 or SelectMonster == "Mythological Pirate [Lv. 1850]" then -- Mythological Pirate [Lv. 1850]
					...
					NameMon = "Mythological Pirate"
					CFrameQ = CFrame.new(-13234.04, 331.488495, -7625.40137, 0.707134247, -0, -0.707079291, 0, 1, -0, 0.707079291, 0, 0.707134247)
					CFrameNearMon = CFrame.new(-13405.2685546875, 483.9862365722656, -6835.01513671875)
				...
				elseif Lv >= 1900 and Lv <= 1924 or SelectMonster == "Jungle Pirate [Lv. 1900]" then -- Jungle Pirate [Lv. 1900]
					...
					CFrameNearMon = CFrame.new(-12089.576171875, 331.73828125, -10550.607421875)
				...
				elseif Lv >= 1925 and Lv <= 1974 or SelectMonster == "Musketeer Pirate [Lv. 1925]" then -- Musketeer Pirate [Lv. 1925]
					...
					NameMon = "Musketeer Pirate"
					CFrameQ = CFrame.new(-12680.3818, 389.971039, -9902.01953, -0.0871315002, 0, 0.996196866, 0, 1, 0, -0.996196866, 0, -0.0871315002)
					CFrameNearMon = CFrame.new(-13390.8564453125, 391.545654296875, -9854.8681640625)
				...
				elseif Lv >= 1975 and Lv <= 1999 or SelectMonster == "Reborn Skeleton [Lv. 1975]" then
					...
					CFrameNearMon = CFrame.new(-8777.63671875, 142.10482788085938, 6046.39208984375)
				...
				elseif Lv >= 2000 and Lv <= 2024 or SelectMonster == "Living Zombie [Lv. 2000]" then
					...
					NameMon = "Living Zombie"
					CFrameQ = CFrame.new(-9480.8271484375, 142.13066101074, 5566.0712890625)
					CFrameNearMon = CFrame.new(-10159.1533203125, 138.62667846679688, 5921.89892578125)
				...
				elseif Lv >= 2025 and Lv <= 2049  or  SelectMonster == "Demonic Soul [Lv. 2025]" then
					...
					CFrameNearMon = CFrame.new(-9527.7587890625, 172.10482788085938, 6164.76318359375)
				...
				elseif Lv >= 2050 and Lv <= 2074 or SelectMonster == "Posessed Mummy [Lv. 2050]" then
					...
					CFrameQ = CFrame.new(-9516.9931640625, 178.00651550293, 6078.4653320313)
					CFrameNearMon = CFrame.new(-9552.2509765625, 6.104852199554443, 6168.51611328125)
				...
				elseif Lv >= 2075 and Lv <= 2099 or SelectMonster == "Peanut Scout [Lv. 2075]" then
					...
					CFrameNearMon = CFrame.new(-2164.680908203125, 38.1037483215332, -10145.4462890625)
				...
				elseif Lv >= 2100 and Lv <= 2124 or SelectMonster == "Peanut President [Lv. 2100]" then
					...
					CFrameQ = CFrame.new(-2104.17163, 38.1299706, -10194.418, 0.758814394, -1.38604395e-09, 0.651306927, 2.85280208e-08, 1, -3.1108879e-08, -0.651306927, 4.21863646e-08, 0.758814394)
					CFrameNearMon = CFrame.new(-2172.630859375, 88.2388916015625, -10500.203125)
				...
				elseif Lv >= 2125 and Lv <= 2149 or SelectMonster == "Ice Cream Chef [Lv. 2125]" then
					...
					CFrameNearMon = CFrame.new(-885.3577270507812, 65.81952667236328, -10967.40625)
				...
				elseif Lv >= 2150 and Lv <= 2199 or SelectMonster == "Ice Cream Commander [Lv. 2150]" then 
					...
					CFrameNearMon = CFrame.new(-600.2125854492188, 65.819580078125, -11341.9375)
				...
				elseif Lv >= 2200 and Lv <= 2224 or SelectMonster == "Cookie Crafter [Lv. 2200]" then 
					...
					CFrameNearMon = CFrame.new(-2353.24560546875, 37.79812240600586, -12121.416015625)
					CFrameMon = CFrame.new(-2286.684326171875, 146.5656280517578, -12226.8818359375)
					TelePBoss(CFrameQ)
					SelectMonster = "Ice Cream Commander [Lv. 2150]"
				elseif Lv >= 2225 and Lv <= 2249 or SelectMonster == "Cake Guard [Lv. 2225]" then 
					...
					NameMon = "Cake Guard"
					CFrameQ = CFrame.new(-2020.6068115234375, 37.82400894165039, -12027.80859375)
					CFrameNearMon = CFrame.new(-1567.8779296875, 37.7981071472168, -12386.3583984375)
					CFrameMon = CFrame.new(-1817.9747314453125, 209.5632781982422, -12288.9228515625)
					SelectMonster = "Cookie Crafter [Lv. 2200]"
					TelePBoss(CFrameQ)
					SelectMonster = "Cookie Crafter [Lv. 2200]"
				elseif Lv >= 2250 and Lv <= 2275 or SelectMonster == "Baking Staff [Lv. 2250]" then 
					Ms = "Baking Staff [Lv. 2250]"
					NameQuest = "CakeQuest2"
					QuestLv = 1
					NameMon = "Baking Staff"
					CFrameQ = CFrame.new(-1928.31763, 37.7296638, -12840.626)
					CFrameNearMon = CFrame.new(-1831.231689453125, 37.798213958740234, -12949.189453125)
					CFrameMon = CFrame.new(-1818.347900390625, 93.41275787353516, -12887.66015625)
					TelePBoss(CFrameQ)
					SelectMonster = "Cake Guard [Lv. 2225]"
				elseif Lv >= 2275 and Lv <= 2300 or SelectMonster == "Head Baker [Lv. 2275]" then
					Ms = "Head Baker [Lv. 2275]"
					NameQuest = "CakeQuest2"
					QuestLv = 2
					NameMon = "Head Baker"
					CFrameQ = CFrame.new(-1928.31763, 37.7296638, -12840.626)
					CFrameNearMon = CFrame.new(-2228.128662109375, 53.50241470336914, -12838.361328125)
					CFrameMon = CFrame.new(-2180.455078125, 53.3980712890625, -12733.564453125)
					TelePBoss(CFrameQ)
					SelectMonster = "Baking Staff [Lv. 2150]"
                elseif Lv >= 2300 and Lv <= 2325 or SelectMonster == "Cocoa Warrior [Lv. 2300]" then
                    Ms = "Cocoa Warrior [Lv. 2300]"
                    NameQuest = "ChocQuest1"
                    QuestLv = 1
                ...
                elseif Lv >= 2350 and Lv <= 2375 or SelectMonster == "Sweet Thief [Lv. 2350]" then
                    ...
                    CFrameMon = CFrame.new(4.2881951332092285, 24.793920516967773, -12621)
                    TelePBoss(CFrameQ)
					SelectMonster = "Chocolate Bar Battlers [Lv. 2325]"
                elseif Lv >= 2375 and Lv <= 2401 or SelectMonster == "Candy Rebel [Lv. 2375]" then
                    Ms = "Candy Rebel [Lv. 2375]"
                    NameQuest = "ChocQuest2"
                    QuestLv = 2
                    NameMon = "Candy Rebels"
...
local win = library:Window("ARTT",[[Hub]],[[Version : Beta ]],"",Enum.KeyCode.RightControl)
local General_Tab = win:Tab("AutoFarm")
local Quest_Tab = win:Tab("Item and Other Quest")
local Island_Tab = win:Tab("Island")
local Raid_Tab = win:Tab("Raid")
local PvP_Tab = win:Tab("PvP")
local Shop_Tab = win:Tab("Shop")
local Setting_Tab = win:Tab("Setting")
local Status_Tab = win:Tab("Status")
local Esp_Tab = win:Tab("ESP")
local Hop_Tab = win:Tab("Hop")
...
General_Tab:Toggle("Auto Farm","9606294253",_G.Setting_table.AutoFarm,function(vu)
	...
	local CbFw2 = CbFw[2]--2

    function GetCurrentBlade() 
        local p13 = CbFw2.activeController
        local ret = p13.blades[1]--1
...
Quest_Tab:Toggle("Auto GodHuman", "9606294253",_G.Setting_table.GodHuman,function(vu)
    _G.Setting_table.GodHuman = vu
...
Quest_Tab:Seperator("Material")
Quest_Tab:Toggle("Auto Fish Tail","9606294253",_G.Setting_table.FishTail,function(vu)
    _G.Setting_table.FishTail = vu
    Update_Setting(getgenv()['MyName'])
end)
...
elseif Three_World  then
	...
	Island_Tab:Button("Chocolate Island",function()
		TP2(CFrame.new(225.08164978027344, 37.12561798095703, -12234.7548828125))
	end)
end
